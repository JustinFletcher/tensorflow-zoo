...
class Model(object):
    ...
    def __init__(self, input_size, label_size, hl_size, learning_rate,
    ...
    def inference(self, input=None):
        ...
        with tf.name_scope('fully_connected1'):
            ...
            W_fc1 = self.weight_variable([self.input_size, self.hl_size])
            b_fc1 = self.bias_variable([self.hl_size])
        ...
        with tf.name_scope('readout'):
            ...
            W_fc2 = self.weight_variable([self.hl_size, self.label_size])
